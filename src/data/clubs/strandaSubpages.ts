...
interface StrandaSubpageFeatureCard {
  icon: 'course' | 'access' | 'community';
  eyebrow: string;
  title: string;
  text: string;
}

interface StrandaSubpagePracticalRow {
  label: string;
  value: string;
}

interface StrandaSubpageBulletCard {
  icon?: 'course' | 'access' | 'community';
  title: string;
  text?: string;
  bullets: string[];
  chips?: string[];
  rows?: StrandaSubpagePracticalRow[];
  cta?: LinkContent;
}

interface StrandaSubpagePricingCard {
  title: string;
  intro: string;
  items: {
    label: string;
...
export interface StrandaSubpageContent {
  seoTitle: string;
  ...
  intro: {
    ...
    title: string;
    subtitle: string;
    features: StrandaSubpageFeatureCard[];
    cardTitle?: string;
    cardBody?: string;
    chips?: string[];
  };
  ...
  detailSection: {
    ...
    title: string;
    subtitle: string;
    cards: StrandaSubpageBulletCard[];
  };
  mediaSection: {
    sectionLabel: string;
    title: string;
  ...
  pricingSection?: {
    ...
    title: string;
    subtitle: string;
    cards: StrandaSubpagePricingCard[];
  };
  ctaSection: {
    sectionLabel: string;
    title: string;
...
export const strandaSubpages: Record<StrandaSubpageSlug, StrandaSubpageContent> = {
  bane: {
